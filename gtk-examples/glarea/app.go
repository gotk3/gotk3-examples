...
const appId = "com.github.gotk3.gotk3-examples.glarea"
...
func main() {
	...
	application.Connect("activate", func() {
		...
		// Get the GtkBuilder UI definition in the ui definition file.
		builder, err = gtk.BuilderNewFromFile("ui/glarea.ui")
		errorCheck(err)
